...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright wilsonmichaelpatrick, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/sines-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/sines-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/sines-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/sines-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/sines-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/sines-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/sines-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/sines.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/sines.iss",inplace=1):
